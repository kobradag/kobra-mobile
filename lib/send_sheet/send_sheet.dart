...
class _SendSheetState extends ConsumerState<SendSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> scanQrCode() async {
      ...
      final prefix = ref.read(addressPrefixProvider);
      final uri = KobraUri.tryParse(qrData, prefix: prefix);
  ...
  Widget getEnterAmountContainer() {
    return HookConsumer(builder: (context, ref, _) {
      ...
      final kobraFormatter = ref.watch(kobraFormatterProvider);
      ...
      void onValueChanged(String text) {
        final value = switch (fiatMode) {
          true => () {
              final price = ref.read(kobraPriceProvider);
          ...
          false => kobraFormatter.tryParse(text),
        };
      ...
      return FiatValueContainer(
        ...
        child: AppTextField(
          ...
          inputFormatters: [fiatMode ? fiatFormatter : kobraFormatter],
