...
BoxInfo _genBoxInfo({
  ...
  final addressBoxKey = hash('addressBoxKey#KobraNetwork.$networkId#$wid');
  final balanceBoxKey = hash('balanceBoxKey#KobraNetwork.$networkId#$wid');
  final utxoBoxKey = hash('utxoBoxKey#KobraNetwork.$networkId#$wid');
  final txIndexBoxKey = hash('txIndexBoxKey#KobraNetwork.$networkId#$wid');
  final txBoxKey = hash('txBoxKey#KobraNetwork.$networkId#$wid');
    ...
    if (!bundle.wasMigrated) {
      ...
      bundle = bundle.copyWith(
        byNetworkId: mainnet != null
            ? {
                ...bundle.byNetworkId,
                kKobraNetworkIdMainnet: mainnet,
              }
            : bundle.byNetworkId,
        wasMigrated: true,
      );
