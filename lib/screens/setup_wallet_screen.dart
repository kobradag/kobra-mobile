  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Future<void> setupWallet() async {
      try {
        ...
        // address discovery
        final client = ref.read(kobraClientProvider);
        final api = ref.read(KobraApiServiceProvider);
        ...
        if (network == KobraNetwork.mainnet && !introData.generated) {
              ...
              child: Column(
                ...
                children: [
                  FractionallySizedBox(
                    ...
                    child: FittedBox(
                      fit: BoxFit.fitWidth,
                      child: Image.asset('assets/kobra.png'),
                    ),
                  ),
                  Column(
                    children: [
