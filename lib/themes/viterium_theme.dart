...
class ViteriumTheme extends BaseTheme {
  static const brightBlue = Color(0xff23e5dc);

  //static const teal = Color(0xfffc865a);
  static const teal = Color(0xfffdc453);

  //static const greenDark = Color(0xfffc865a);
  static const greenDark = Color(0xff004a50);

  static const blueishGreyDark = Color(0xff003034);

  static const blueishGreyLight = Color(0xff004a50);

  static const blueishGreyDarkest = Color(0xff003034);
