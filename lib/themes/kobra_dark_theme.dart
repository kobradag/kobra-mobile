...
class KobraDarkTheme extends BaseTheme {
  static const brightBlue = Color(0xFFffffff);

  static const teal = Color(0xFFffffff);

  static const greenDark = Color(0xfffc865a);

  static const blueishGreyDark = Color(0xFF161818);
  static const blueishGreyLight = Color(0xFF101212);
