...
class ReceiveSheet extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final kobraUri = KobraUri(address: receiveAddress.address, amount: amount);
    ...
    Future<void> copyUri() async {
      try {
        await Clipboard.setData(ClipboardData(text: kobraUri.toString()));
        UIUtil.showSnackbar(l10n.kobraUriCopied, context);
      } catch (_) {
        UIUtil.showSnackbar(l10n.kobraUriCopyFailed, context);
      }
    }
