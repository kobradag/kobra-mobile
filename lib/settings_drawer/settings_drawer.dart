...
class _SettingsSheetState extends ConsumerState<SettingsSheet>
  ...
  Widget buildMainSettings(BuildContext context) {
    return Consumer(builder: (context, ref, _) {
      ...
      void contactSupport() =>
          openUrl('mailto:$kSupportEmail?subject=Kobra Mobile support');

      void share() {
        Share.share(
          l10n.shareKobraMobileText,
          subject: l10n.shareKobraMobileSubject,
        );
      }
                ...
                child: Stack(children: [
                  ListView(
                    ...
                    children: [
                      ...
                      // if (network == KobraNetwork.mainnet) ...[
                      //   Divider(height: 2, color: theme.text15),
                      //   DoubleLineItem(
                      //     heading: l10n.buyKobraTitle,
                      ...
                      if (canDonate) ...[
                       ...
                       //defaultMethod: SettingSelectionItem(title: kSupportEmail),
                       // icon: Icons.email,
                       // onPressed: contactSupport,
                      //),
                      Divider(height: 2, color: theme.text15),
                      SingleLineItem(
                        heading: l10n.shareKobraMobile,
