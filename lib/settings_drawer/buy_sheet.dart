...
class BuySheet extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    void buyKobra() {
      ...
      final uri = Uri.https('kobra-topper.vercel.app', '/api/topper', {
        'source': source,
        'target': 'KODA',
      ...
      mainWidget: Column(
        ...
        children: [
          Container(
            ...
            child: Text(
              l10n.buyKobraMessage + '\n' + l10n.buyKobraMessageSecondary,
